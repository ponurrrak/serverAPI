module.exports = {
  testimonials : [
    ...
    { id: 3, author: 'Jack Diamond', text: 'They are high level professionals!' },
    { id: 4, author: 'Mia Lucky', text: 'I have never met so cooperative team!' },
    { id: 5, author: 'Lucy In-the-sky', text: 'You can rely on them.' },
    { id: 6, author: 'Marry Christmas', text: 'No company is better!' },
  ],
  concerts: [
